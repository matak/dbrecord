...
class DbMapper extends Object implements IObjectContainerToFree
{

	/** @var string classname of System\DbRecord\DbRecord */
	protected $recordClass;

	/** @var \System\DbRecord\DbRecordConfig */
	protected $config;
	...
	/** @var array */
	public $onBeforeInsertAfterValidation;
	...
	/** @var array */
	public $onBeforeUpdateAfterValidation;
	...
	/**
	 * Get DbRecordConfiguration object of DbRecord
	 * @return System\DbRecord\DbRecordConfig
	 */
	public function getConfig()
	{
		if (!$this->config) {
			...
			$cache = new Cache($context->cacheStorage, str_replace("\\", ".", __NAMESPACE__) . ".DbRecord");
			...
			if ($config === null) {
				$configClass = $class::DEFAULT_CONFIG;
				$config = new $configClass;
				$config->autoDetect($class);
